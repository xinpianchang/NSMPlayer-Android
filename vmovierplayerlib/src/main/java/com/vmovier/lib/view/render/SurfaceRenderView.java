...
public class SurfaceRenderView extends SurfaceView implements IRenderView {
    ...
    public void setVideoSize(int videoWidth, int videoHeight) {
        if (mVideoHeight == videoHeight && mVideoWidth == videoWidth) {
            return;
        }
    ...
    public void setScaleType(int scaleType) {
        Log.d(TAG,"SurfaceRenderView  setScaleType  scaleType --->" + scaleType);
    ...
    private static final class InternalSurfaceHolder implements ISurfaceHolder {
        ...
        public void bindToMediaPlayer(@NonNull IPlayer mp) {
